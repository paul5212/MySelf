...
save_roi = True  # 新增 bool 開關：是否儲存 ROI 截圖
...
def compute_blur_and_draw_roi(image_path, center_x, center_y, ip, slice_num):
    try:
        ...
        # 如果 save_roi 為 True，儲存補齊後的 ROI 截圖
        if save_roi:
